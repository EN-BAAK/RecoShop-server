...
import { getAllUsers, deleteUser, getOwnProfile, getUserProfile, getAdminsAndManagers } from "../controllers/user";
...
router.get("/admins-and-managers", verifyAuthentication, requirePermission(PERMISSIONS.VIEW_PRIVATE), getAdminsAndManagers);
